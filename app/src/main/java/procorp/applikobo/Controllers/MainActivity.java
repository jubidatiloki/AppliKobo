...
public class MainActivity extends AppCompatActivity {
    ...
    private Button btnCreation, btnListe, btnRegles;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRegles = findViewById(R.id.btnRegles);
        ...
        btnRegles.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(MainActivity.this, "promis, ca arrive soon", Toast.LENGTH_LONG).show();
            }
        });
